    ...
    reviewsHtml += `
        <div class="review">
          <div class="review-header">
            <span class="review-author">${review.author.charAt(
              0
            )}</span> <!-- Displaying just the first letter of the author's name -->
...
function selectDuration(duration) {
  ...
  document
    .querySelector(
      '.time-button[onclick="selectDuration(\'' + duration + '\')"]'
    )
...
function toggleResumeSection(section) {
  ...
  document
    .querySelector(`.resume-tab[onclick="toggleResumeSection('${section}')"]`)
